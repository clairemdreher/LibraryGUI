...
VALUES 
    ('Interview with the Vampire', 'Anne', 'Rice', 'Gothic Horror', 1976, 6, 5),
    ('Paper Towns', 'John', 'Green', 'Young Adult Fiction', 2008, 3, 3),
    ('Rebecca', 'Daphne', 'de Maurier', 'Gothic Horror', 1938, 1, 1),
    ('1984', 'George', 'Orwell', 'Fiction', 1949, 2, 2),
    ('Twilight', 'Stephanie', 'Meyer', 'Fiction', 2005, 6, 6),
    ('The Master and Margarita', 'Mikhail', 'Bulgakov', 'Fiction', 1973, 1, 1),
    ('The Picture of Dorian Gray', 'Oscar', 'Wilde', 'Gothic Fiction', 1891, 2, 1),
    ('The Stranger', 'Albert', 'Camus', 'Fiction', 1942, 3, 3),
    ('YOU', 'Caroline', 'Kepnes', 'Fiction', 2014, 2, 2),
    ('The Shining', 'Stephen', 'King', 'Horror', 1977, 5, 5),
    ('Dracula', 'Bram', 'Stoker', 'Horror', 1897, 3, 3),
    ('Jane Eyre', 'Charlotte', 'Bronte', 'Classic Fiction', 1847, 1, 0);
